...
else if ENV['USE_TYPE']
    spec.vendored_frameworks = 'YXCollegeSDK/Frameworks/YXCollegeSDK.framework',
                               'YXCollegeSDK/Frameworks/JSHFMBase.framework',
                               'YXCollegeSDK/Frameworks/JSHFMH5NativeInteractive.framework'
else
    spec.vendored_frameworks = 'YXCollegeSDK/Frameworks/*.framework'
end

spec.dependency 'VODUpload'  #阿里云视频上传sdk

spec.dependency 'HDVideoClass_Remote' #CC视频sdk
